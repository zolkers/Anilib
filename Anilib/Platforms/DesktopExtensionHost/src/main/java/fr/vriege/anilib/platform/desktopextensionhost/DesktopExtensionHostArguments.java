...
record DesktopExtensionHostArguments(InetAddress address, int port, Path dataDirectory) {
    static DesktopExtensionHostArguments parse(String[] arguments) {
        ...
        try {
            return new DesktopExtensionHostArguments(InetAddress.getByName(host), port, Path.of(data));
