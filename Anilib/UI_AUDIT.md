...
| Reader settings and reader | [x] | Partial | Immersive pages, resume, slider, LTR/RTL/vertical/webtoon, prefetch, retry, persisted gestures, scale/fit, crop, split/dual pages, rotation, and webtoon spacing are live; add color filters, transitions, orientation policy, and per-title overrides |
