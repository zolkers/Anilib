...
| Data, storage, and advanced settings | [x] | Partial | A dedicated page owns durable User-Agent/proxy/DoH/timeout/cache policy, per-source diagnostics, confirmed cleanup, backup, and About routes; add storage inspection and crash logs |
