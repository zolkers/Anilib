...
| Library and update settings | [x] | Partial | Wi-Fi policies, automatic download category/media-limit/cleanup rules, and the update schedule/skip controls are live; add category defaults and exceptions |
