...
| Reader settings and reader | [x] | Partial | Immersive pages, resume, slider, navigation modes, persisted gestures/display controls, color and brightness filters, transitions, Android orientation policy, and per-title overrides are live; add chapter navigation and complete reader menu actions |
