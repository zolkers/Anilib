...
public record SettingsSnapshot(
    ...
    public SettingsSnapshot {
        ...
        Objects.requireNonNull(applicationWindowMode, "applicationWindowMode must not be null");
    ...
    public SettingsSnapshot withApplicationWindowMode(ApplicationWindowMode value) {
        return copy(languagePack, themeMode, themeFamily, accentColor, typographyScale, reducedMotion,
                navigationStyle, value, playerWindowMode, browserPolicy, startScreen, showAdultContent,
                incognitoMode, downloadOnlyOnWifi, updateOnlyOnWifi);
    }

    public SettingsSnapshot withPlayerWindowMode(PlayerWindowMode value) {
        return copy(languagePack, themeMode, themeFamily, accentColor, typographyScale, reducedMotion,
                navigationStyle, applicationWindowMode, value, browserPolicy, startScreen, showAdultContent,
                incognitoMode,
    ...
    public SettingsSnapshot withBrowserPolicy(BrowserPolicy value) {
        return copy(languagePack, themeMode, themeFamily, accentColor, typographyScale, reducedMotion,
                navigationStyle, applicationWindowMode, playerWindowMode, value,
                startScreen, showAdultContent, incognitoMode, downloadOnlyOnWifi, updateOnlyOnWifi);
    }

    public SettingsSnapshot withStartScreen(StartScreen value) {
        return copy(languagePack, themeMode, themeFamily, accentColor, typographyScale, reducedMotion,
                navigationStyle, applicationWindowMode, playerWindowMode, browserPolicy,
    ...
    private static SettingsSnapshot copy(
        ...
        return new SettingsSnapshot(languagePack, themeMode, themeFamily, accentColor, typographyScale, reducedMotion,
                navigationStyle, applicationWindowMode, playerWindowMode, browserPolicy, startScreen,
                showAdultContent, incognitoMode, downloadOnlyOnWifi, updateOnlyOnWifi);
    }
}
