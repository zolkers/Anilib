...
| --- | --- | --- | --- |
| Library | Partial | Durable anime/manga titles, category CRUD and policies, favourites, progress, filters, persisted display choices, multi-selection and bulk actions, complete title details, plus date-grouped searchable history with anime/manga filters and resume/remove actions | Complete statistics depth |
