...
| Reader | Partial | LTR, RTL, vertical, webtoon, resume, prefetch, local/remote pages, persisted gestures, scaling/fit policies, border crop, split/dual pages, rotation, and webtoon spacing | Color filters, brightness, transitions, orientation policy, and per-title overrides |
