...
| Player | Partial | Episodes, qualities, subtitles, resume, protected streams, Android/desktop playback, complete transport controls, seek/brightness/volume gestures, speed, orientation, lock, fullscreen, configurable buttons, durable decoder/audio/subtitle/quality policies, intro/outro skipping, and per-title overrides | PiP/background behavior and mpv-compatible advanced controls |
