...
| Tracking | Partial | Versioned adapter SDK, durable binding/editing UI, and opt-in AniList token plus Kitsu password-authentication Bundles | Provider icons, richer dialogs, automatic synchronization, conflicts, and sync preferences |
