...
| Settings | Partial | Removable Settings Bundle, atomic persistence, dedicated shared destinations, selectable language packs, theme mode/family/accent, typography scale, adaptive/forced navigation, category defaults and exceptions, enforced policies, bounded storage inspection, logs/crash reports, native diagnostic export, and allowlisted two-phase resets | Complete WebView and localization depth listed in the UI audit |
