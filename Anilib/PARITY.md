...
| Player | Partial | Episodes, qualities, subtitles, resume, protected streams, Android/desktop playback, complete controls and gestures, durable playback policies and per-title overrides, intro/outro skipping, plus Android PiP and foreground-service-backed background audio | Desktop mpv-compatible advanced controls |
