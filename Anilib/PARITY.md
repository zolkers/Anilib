...
| WebView | Partial | Source API 1.6 source/title entry points, Android System WebView, desktop KCEF, navigation controls, bidirectional shared-cookie handoff, per-source headers/User-Agent, and challenge-cookie verification | Automatic provider-specific challenge retry, file chooser/pop-up/download handling, browser settings, and complete WebView data clearing |
