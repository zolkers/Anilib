...
| Reader | Partial | LTR, RTL, vertical, webtoon, resume, prefetch, local/remote pages, persisted gestures, complete display controls, color/brightness filters, page transitions, Android orientation policy, and global or per-title preferences | Chapter lists, cross-chapter navigation, and complete reader menus/download/read-state actions |
