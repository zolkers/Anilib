...
| APK extensions (Android) | Partial | HTTPS APK download, PackageInstaller hand-off, anime/manga package discovery, certificate trust, content-specific host-ABI preflight, and pre-start adaptation of ABI-ready anime catalogues, episodes, streams, headers, subtitles, filters, and source preferences into Source Bundles | Supply the complete external host ABI and add manga source execution; portable Anilib bundles remain the active Android/desktop format |
