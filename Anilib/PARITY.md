...
| Reader | Partial | LTR, RTL, vertical, webtoon, resume, prefetch, local/remote pages, and persisted customization for tap zones, swipes, double taps, and long presses | Scaling, crop/split, rotation, color, transitions, and per-title overrides |
