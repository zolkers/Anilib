...
| Downloads | Partial | Durable grouped priority queue, reorder/delete-all, speed/ETA, partial recovery, pause/resume/cancel, quotas, offline fallback, validated custom storage with migration, index repair, and per-title actions | Complete all automatic-download policies |
