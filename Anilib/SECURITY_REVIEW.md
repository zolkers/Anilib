...
| Desktop APK engine | User-pinned SHA-256, non-link JAR validation, disposable runtime copy, exact Java executable, sanitized environment, `127.0.0.1` binding, bounded startup and owned-process shutdown | `ExtensionRepositoryTest`, desktop compilation, architecture boundary gate | Engine and extension code are third-party; native signed Bundles remain preferred |
