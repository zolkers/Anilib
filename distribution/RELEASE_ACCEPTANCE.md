...
- [ ] Android keystore, alias, store-password, and key-password secrets are configured.
...
secret names are documented in the Android and Desktop release guides.
...
- [ ] Android producer run: `________________`
...
- [ ] GitHub provenance attestations exist for APK, MSI, DEB, and DMG.
...
- [ ] Android: clean install, update, permission flow, launch, and data retention verified.
...
- [ ] Play Console release ID or `not submitted`: `________________`
